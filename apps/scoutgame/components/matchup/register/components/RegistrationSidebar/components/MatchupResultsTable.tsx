...
import { getPreviousWeek, getCurrentWeek, getCurrentSeasonWeekNumber } from '@packages/dates/utils';
...
export async function MatchupResultsTable({ week, weekNumber }: { week: string; weekNumber: number }) {
  if (weekNumber < 1) {
    return null;
  }
